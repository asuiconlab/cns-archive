...
$qs = "SELECT uid,sid,title,cmdsuccess,lname1,fname1,email1,lname2,fname2,email2,lname3,fname3,email3,lname4,fname4,email4,lname5,fname5,email5,lname6,fname6,email6,lname7,fname7,email7,lname8,fname8,email8 FROM tsub WHERE cmdsuccess='y' and locked='n' AND sid BETWEEN $min_sid AND $max_sid ORDER BY sid";
...
<html>
<head>
<title>CNS*2000 Reviewer Assignment - Papers $min-$max</title>
</head>
<body bgcolor=white>
